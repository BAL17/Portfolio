const MainBody = () => {
  return (
    <>
      ...
      <div className=" flex flex-col justify-center items-center border-2 h-full w-1/2">
        <div className="flex">
      ...
      <div className="flex flex-col border-2 justify-center items-center border-red-700 h-full w-1/2 gap-1">
        <div>
